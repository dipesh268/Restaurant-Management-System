			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Welcome resturent</span></h1>
						<h4>Little Story</h4>
